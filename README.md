...
* **Resume Contents**: The config variable "default_resume_contents:" is the list of Element Templates used by defaultContents.html to generate the Resume. ***NOTE: This list is the ORDER the Elements will appear in on the Resume. Element order can ONLY be changed from here!***
